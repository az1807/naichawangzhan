    ...
    <div>
        <div class="footer-info">
            <div class="footer-content">
               ...
               <div>
                <p>招商热线:  <%
               Foot gongsi =  (Foot)request.getAttribute("company");
                 %>
                ...
                <div class="footer-box">
                    ...
                    <span>公司电话:</span>
                    <span> <%
               Foot gongs =  (Foot)request.getAttribute("company");
                 %>
                ...
                <div class="footer-box">
                    ...
                    <span>公司邮箱:</span>
                    <span> <%
               Foot gong =  (Foot)request.getAttribute("company");
                 %>
                ...
                <div class="footer-box">
                    ...
                    <span>公司地址:</span>
                    <span><%
               Foot gon =  (Foot)request.getAttribute("company");
                 %>
